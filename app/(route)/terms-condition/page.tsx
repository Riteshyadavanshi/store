  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 px-4">
      ...
      <p className="mb-4">
        ...
        {"our"} used anywhere on this page shall mean SHOPHOLIC DIARIES, whose
        registered/operational office is 101 shiv kalash bldg , plot
        no.62,sector 50e,new seawoods Thane MAHARASHTRA 400706 . {"you"},{"your"},
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          ...
          document without SHOPHOLIC DIARIES’s prior written consent.
        </li>
        <li>
